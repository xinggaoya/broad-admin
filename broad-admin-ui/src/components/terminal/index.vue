<template>
    <el-dialog v-bind="$attrs" v-model="terminal.state.show" :title="t('terminal.Terminal')"
               custom-class="ba-terminal-dialog" :append-to-body="true">
                ...
                <el-card>
                    ...
                    <template v-if="item.status != taskStatus.Waiting">
                        ...
                        >
                            ...
                            <Icon :name="item.showMessage ? 'el-icon-ArrowUp' : 'el-icon-ArrowDown'" size="16"
                                  color="#909399"/>
                        </div>
                        <div
                            v-if="
        ...
        <el-button-group>
            <el-button class="terminal-menu-item" icon="el-icon-MagicStick" v-blur
                       @click="terminal.addTaskPM('test-install', false)">{{
                    t('terminal.Test command')
                }}
            </el-button>
            <el-button class="terminal-menu-item" icon="el-icon-Download" v-blur
                       @click="terminal.addTaskPM('web-install')">{{
                    t('terminal.Install dependent packages')
                }}
            </el-button>
            <el-button class="terminal-menu-item" icon="el-icon-Sell" v-blur @click="webBuild()">
                {{ t('terminal.Republish') }}
            </el-button>
            <el-button v-if="!state.menuExpand" class="terminal-menu-item" icon="el-icon-Expand" v-blur
                       @click="state.menuExpand = true"></el-button>
            <template v-else>
                ...
                <el-button class="terminal-menu-item" icon="el-icon-Switch" v-blur
                           @click="terminal.togglePackageManagerDialog(true)"
                >{{ t('terminal.Package manager') }} {{ terminal.state.packageManager.toUpperCase() }}
                </el-button
                >
                <el-button class="terminal-menu-item" icon="el-icon-Tools" v-blur
    ...
    >
        ...
        <template #footer>
            <div class="package-manager-dialog-footer">
                ...
                <el-button @click="changePackageManager('none')">{{
                        t('terminal.I want to execute the command manually')
                    }}
                </el-button>
            </div>
        </template>
