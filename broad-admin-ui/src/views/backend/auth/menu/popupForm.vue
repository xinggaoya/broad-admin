            ...
            >
                ...
                >
                    ...
                    <el-form-item v-if="baTable.form.items!.type == 'menu'" :label="t('auth.menu.Menu type')">
                        <el-radio v-model="baTable.form.items!.menuType" label="tab" :border="true">{{ t('auth.menu.Menu type tab') }}</el-radio>
                        <el-radio v-model="baTable.form.items!.menuType" label="link" :border="true">{{
                            t('auth.menu.Menu type link (offsite)')
                        }}</el-radio>
                        <el-radio v-model="baTable.form.items!.menuType" label="iframe" :border="true">Iframe</el-radio>
                    </el-form-item>
                    <el-form-item prop="url" v-if="baTable.form.items!.menuType != 'tab'" :label="t('auth.menu.Link address')">
                        <el-input
